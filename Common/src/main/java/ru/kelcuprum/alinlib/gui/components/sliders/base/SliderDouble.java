...
public class SliderDouble extends SliderPercent {
    ...
    public SliderDouble(int x, int y, AbstractStyle style, double position, double min, double max, Component label) {
    ...
    public SliderDouble(int x, int y, AbstractStyle style, double position, double min, double max, Component label, OnPress onPress) {
    ...
    public SliderDouble(int x, int y, int width, int height, AbstractStyle style, double position, double min, double max, Component label) {
    ...
    public SliderDouble(int x, int y, int width, int height, AbstractStyle style, double position, double min, double max, Component label, OnPress onPress) {
