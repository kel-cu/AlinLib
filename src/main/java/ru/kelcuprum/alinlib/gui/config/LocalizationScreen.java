    ...
    public static Screen build(Screen parent) {
        ...
        builder.addWidget(new TextBox(Component.translatable("alinlib.localization"), true))
                ...
                .addWidget(new CategoryBox(Component.translatable("alinlib.localization.sides"))
                        ...
                        .addValue(new EditBoxBuilder(Component.translatable("alinlib.localization.north.debug")).setLocalization(AlinLib.localization, "north.debug"))
                        .addValue(new EditBoxBuilder(Component.translatable("alinlib.localization.south.debug")).setLocalization(AlinLib.localization, "south.debug"))
                        .addValue(new EditBoxBuilder(Component.translatable("alinlib.localization.west.debug")).setLocalization(AlinLib.localization, "west.debug"))
                        .addValue(new EditBoxBuilder(Component.translatable("alinlib.localization.east.debug")).setLocalization(AlinLib.localization, "east.debug"))
                )
