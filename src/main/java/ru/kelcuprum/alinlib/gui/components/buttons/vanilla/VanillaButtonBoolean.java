...
public class VanillaButtonBoolean extends AbstractButton {
    ...
    public VanillaButtonBoolean(int x, int y, int width, int height, Config config, String typeConfig, boolean defaultConfig, Component label) {
