...
public class FlatEditBoxSecretString extends AbstractWidget implements Renderable {
    ...
    public FlatEditBoxSecretString(Font font, int i, int j, Component component) {
        this(font, 0, 0, i, j, component);
    }

    public FlatEditBoxSecretString(Font font, int i, int j, int k, int l, Component component) {
        this(font, i, j, k, l, (EditBox)null, component);
    }
    public FlatEditBoxSecretString(int i, int j, int k, int l, Component component) {
        this(Minecraft.getInstance().font, i, j, k, l, (EditBox)null, component);
    }

    public FlatEditBoxSecretString(Font font, int i, int j, int k, int l, @Nullable EditBox editBox, Component component) {
