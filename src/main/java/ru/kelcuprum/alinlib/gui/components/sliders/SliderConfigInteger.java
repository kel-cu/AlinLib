...
public class SliderConfigInteger extends SliderInteger implements Resetable {
    ...
    public SliderConfigInteger(int x, int y, AbstractStyle style, Config config, String typeConfig, int defaultConfig, int min, int max, Component label) {
    ...
    public SliderConfigInteger(int x, int y, int width, int height, AbstractStyle style, Config config, String typeConfig, int defaultConfig, int min, int max, Component label) {
        super(x, y, width, height, style, config.getNumber(typeConfig, defaultConfig).intValue(), min, max, label);
        this.config = config;
