...
public class VanillaEditBoxSecretString extends AbstractWidget implements Renderable {
//    private static final WidgetSprites SPRITES = new WidgetSprites(new ResourceLocation("widget/text_field"), new ResourceLocation("widget/text_field_highlighted"));
    private static final WidgetSprites SPRITES = new WidgetSprites(new ResourceLocation("widget/button"), new ResourceLocation("widget/button_highlighted"));
    ...
    public VanillaEditBoxSecretString(Font font, int i, int j, Component component) {
        this(font, 0, 0, i, j, component);
    }

    public VanillaEditBoxSecretString(Font font, int i, int j, int k, int l, Component component) {
        this(font, i, j, k, l, (EditBox)null, component);
    }
    public VanillaEditBoxSecretString(int i, int j, int k, int l, Component component) {
        this(Minecraft.getInstance().font, i, j, k, l, (EditBox)null, component);
    }

    public VanillaEditBoxSecretString(Font font, int i, int j, int k, int l, @Nullable EditBox editBox, Component component) {
