...
public class SelectorStringWithIntButton extends AbstractButton {
    ...
    public SelectorStringWithIntButton(int x, int y, int width, int height, String[] list, int currentPosition, Component label, OnPress onPress) {
        this(x, y, width, height, InterfaceUtils.DesignType.ALINA, list, currentPosition, label, onPress);
    }
    public SelectorStringWithIntButton(int x, int y, int width, int height, InterfaceUtils.DesignType type, String[] list, int currentPosition, Component label, OnPress onPress) {
    ...
    public void onPress() {
        ...
        this.onPressFunction.onPress(this.currentPosition);
    }
