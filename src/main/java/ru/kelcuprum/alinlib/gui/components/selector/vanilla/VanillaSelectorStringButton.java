...
public class VanillaSelectorStringButton extends AbstractButton {
    ...
    public VanillaSelectorStringButton(int x, int y, int width, int height, String[] list, Config config, String typeConfig, String defaultVolume, Component label) {
