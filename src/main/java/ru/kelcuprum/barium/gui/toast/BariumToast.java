package ru.kelcuprum.barium.gui.toast;
...
public class BariumToast implements Toast {
    ...
    public BariumToast(Component title, Component message, boolean isFail) {
        this.title = title;
    ...
    public Visibility render(GuiGraphics guiGraphics, ToastComponent toastComponent, long l) {
        ...
        guiGraphics.renderFakeItem(new ItemStack(isFail ? Items.BARRIER : Items.CRAFTING_TABLE), 8, 8);
