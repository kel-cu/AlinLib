package ru.kelcuprum.barium.gui;
...
import ru.kelcuprum.barium.Barium;
import ru.kelcuprum.barium.gui.components.TextBox;
import ru.kelcuprum.barium.gui.components.buttons.BooleanButton;
import ru.kelcuprum.barium.gui.components.buttons.Button;
import ru.kelcuprum.barium.gui.components.buttons.ButtonWithColor;
import ru.kelcuprum.barium.gui.components.editbox.StringEditBox;
import ru.kelcuprum.barium.gui.components.selector.SelectorStringButton;

import java.awt.*;

public class DemoBariumScreen extends Screen {
    private final Screen parent;
    private static final Component TITLE = Component.literal("Barium");
    ...
    private void initButtonsCategory(){
        ...
        addRenderableWidget(new BooleanButton(140, 40, this.width - 150, 20, Component.literal("Boolean"), "Boolean", true, Barium.bariumConfig));
        ...
        editBox.setValue(Barium.bariumConfig.getString("HELLO", "Hello, world!"));
        editBox.setResponder((string) -> {
                    Barium.bariumConfig.setString("HELLO", string);
                });
        ...
        addRenderableWidget(
                new SelectorStringButton(140, 40+(25*2), this.width - 150, 20, hell, Barium.bariumConfig, "selector", "Hello", Component.literal("Selector"))
        );
        //
    }
